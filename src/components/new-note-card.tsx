...
export function NewNoteCard({ onNoteCreated }: NewNoteProps) {
  ...
  } // função acima precisou tipar o event por estarmos no TypeScript ,esse ChangeEvent foi pego com o macete de botar o mouse em cima do OnChange para descobrir o tipo,isso funciona para outro eventos como OnClick e etc.
